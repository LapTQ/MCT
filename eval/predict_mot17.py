...
for dir in os.listdir(root):
    ...
    output_path = HERE/'./TrackEval/data/trackers/mot_challenge/MOT17-train/SCT/data'
    os.system(f'python {HERE/"../mct/main.py"} --input {input_path} --output {output_path} --save_txt --export_video')
