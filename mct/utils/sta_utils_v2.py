...
def visualize_sta_result(
    ...
    while True:
        ...
        if 390 <= p <= 570 or 1033 <= p <= 1127 or 1532 <= p <= 1771 or 1911 <= p <= 2187:
...
if __name__ == '__main__':
    ...
    VIDEO_SET = {
        ...
        '2d_v4': {'cam_id1': 42, 'cam_id2': 43, 'range_': range(8, 9)},
    }
